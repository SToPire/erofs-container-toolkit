...
type EagerDaemon struct {
	resolverFactory func(ctx context.Context, creds func(host string) (string, string, error)) remotes.Resolver
}
...
func defaultResolver(ctx context.Context, creds func(host string) (string, string, error)) remotes.Resolver {
